...
def is_registered(domain_name):
    """
        A function that returns a boolean indicating whether a domain_name is registerd
...
def resolve_dns_records(target_domain):
    ...
    if __name__ == "__main__":
        parser = argparse.ArgumentParser(description="Domain name information extractor, uses WHOIS db and scan for subdomains")
